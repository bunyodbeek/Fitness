...
urlpatterns = [
    ...
    path("plans/<int:pk>/share-token/", pr.PlanShareTokenView.as_view(), name="plan_share_generate"),
    path("plans/<int:pk>/import/", pr.PlanImportView.as_view(), name="plan_import"),
